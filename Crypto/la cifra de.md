...
Encontré este código en un libro viejo. ¿Puedes descifrar qué dice? Conéctate con `nc jupiter.challenges.picoctf.org 32411`.

mos vamos a conectar al puerto
y al conectarvemos todo este mensaje cifrado
Encrypted message:
...
asi que buscamos una pagina para decifrar


y poniendo nuestro texto nos da esto 
|   |
|---|
